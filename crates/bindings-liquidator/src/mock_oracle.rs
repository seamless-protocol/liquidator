...
pub mod mock_oracle {
    ...
    pub struct MockOracle<M>(::ethers::contract::Contract<M>);
    impl<M> ::core::clone::Clone for MockOracle<M> {
        fn clone(&self) -> Self {
            Self(::core::clone::Clone::clone(&self.0))
        }
    }
    impl<M> ::core::ops::Deref for MockOracle<M> {
        type Target = ::ethers::contract::Contract<M>;
        fn deref(&self) -> &Self::Target {
            &self.0
        }
    }
    impl<M> ::core::ops::DerefMut for MockOracle<M> {
        fn deref_mut(&mut self) -> &mut Self::Target {
            &mut self.0
        }
    }
    impl<M> ::core::fmt::Debug for MockOracle<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(::core::stringify!(MockOracle)).field(&self.address()).finish()
        }
    }
    impl<M: ::ethers::providers::Middleware> MockOracle<M> {
        ...
        > {
            let factory = ::ethers::contract::ContractFactory::new(
                MOCKORACLE_ABI.clone(),
                MOCKORACLE_BYTECODE.clone().into(),
                client,
            );
    ...
    impl ::ethers::contract::EthLogDecode for MockOracleEvents {
        fn decode_log(
            log: &::ethers::core::abi::RawLog,
        ) -> ::core::result::Result<Self, ::ethers::core::abi::Error> {
            if let Ok(decoded) = AssetPriceUpdatedFilter::decode_log(log) {
                return Ok(MockOracleEvents::AssetPriceUpdatedFilter(decoded));
            }
            if let Ok(decoded) = EthPriceUpdatedFilter::decode_log(log) {
                return Ok(MockOracleEvents::EthPriceUpdatedFilter(decoded));
            }
            Err(::ethers::core::abi::Error::InvalidData)
        }
    }
    impl ::core::fmt::Display for MockOracleEvents {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    impl ::core::convert::From<AssetPriceUpdatedFilter> for MockOracleEvents {
        fn from(value: AssetPriceUpdatedFilter) -> Self {
            Self::AssetPriceUpdatedFilter(value)
        }
    }
    impl ::core::convert::From<EthPriceUpdatedFilter> for MockOracleEvents {
    ...
    impl ::ethers::core::abi::AbiDecode for MockOracleCalls {
        fn decode(
            data: impl AsRef<[u8]>,
    ...
    impl ::ethers::core::abi::AbiEncode for MockOracleCalls {
    ...
    impl ::core::fmt::Display for MockOracleCalls {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    impl ::core::convert::From<GetAssetPriceCall> for MockOracleCalls {
        fn from(value: GetAssetPriceCall) -> Self {
            Self::GetAssetPrice(value)
        }
    }
    impl ::core::convert::From<GetEthUsdPriceCall> for MockOracleCalls {
        fn from(value: GetEthUsdPriceCall) -> Self {
            Self::GetEthUsdPrice(value)
        }
    }
    impl ::core::convert::From<SetAssetPriceCall> for MockOracleCalls {
        fn from(value: SetAssetPriceCall) -> Self {
            Self::SetAssetPrice(value)
        }
    }
    impl ::core::convert::From<SetEthUsdPriceCall> for MockOracleCalls {
